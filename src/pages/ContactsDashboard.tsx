...
import HighLevelSegmentsGuide from "@/components/HighLevelSegmentsGuide";
...
interface ContactWithSources {
  ...
  email: string;
  phone: string;
  // Kept in the data layer; the "Appears In" column is hidden in the UI for now.
  sources: string[];
}
        ...
        <div className="overflow-x-auto">
          <Table>
            ...
            <TableBody>
              ...
              {filtered.length === 0 && (
                <TableRow>
                  <TableCell colSpan={3} className="text-center text-steel text-sm py-8">
                    No contacts found
                  </TableCell>
                </TableRow>
              )}
