...
import { STATUS_COLORS, TASK_STATUSES, TaskRow, TaskStatus, compareTasksForStatus, initials } from "./types";
                          ...
                          {(dragProvided, dragSnapshot) => (
                            ...
                            >
                              <p className="text-sm font-medium text-foreground leading-snug">
                                <span className={cn(task.status === "Done" && "line-through text-steel")}>
                                  {task.title}
                                </span>
                                {task.status === "Done" && task.completed_at && (
                                  <span className="ml-1 text-[11px] font-normal text-steel">
