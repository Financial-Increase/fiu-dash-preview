...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-surface">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 ${collapsed ? "w-16" : "w-56"} bg-sidebar border-r border-sidebar-border flex flex-col transition-all duration-200 lg:translate-x-0 lg:sticky lg:top-0 lg:bottom-auto lg:h-screen lg:self-start ${
      ...
      >
        ...
        <nav className={`flex-1 py-4 ${collapsed ? "px-1.5" : "px-3"} space-y-0.5 overflow-y-auto sidebar-scroll`}>
        ...
        <div className={`${collapsed ? "px-2 py-1" : "px-4 py-1.5"} border-t border-sidebar-border space-y-1`}>
