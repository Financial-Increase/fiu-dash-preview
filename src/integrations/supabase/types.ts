  ...
  public: {
    Tables: {
      ...
      digits_oauth_tokens: {
        Row: {
          access_token: string
          connected_by_auth_user_id: string | null
          created_at: string
          digits_client_id: string | null
          expires_at: string
          id: number
    ...
    Views: {
      ...
      funnel_stats: {
        Row: {
          ...
          bump_orders: number | null
          bump_revenue: number | null
          bump_units: number | null
          declined_upsell: number | null
          downsell_buyers: number | null
          downsell_revenue: number | null
          downsell_take_pct: number | null
          downsell_units: number | null
          funnel_name: string | null
          main_buyers: number | null
          main_orders: number | null
          main_revenue: number | null
          main_units: number | null
          total_revenue: number | null
          upsell_buyers: number | null
          upsell_revenue: number | null
          upsell_take_pct: number | null
          upsell_units: number | null
        }
        Relationships: []
      }
    }
    Functions: {
      ...
      derive_offer_type: {
        Args: {
          p_page_url: string
          p_sub_source: string
          p_submission_type: number
          p_trial_period?: number
        }
        Returns: string
      }
      enqueue_email: {
      ...
      refresh_line_item_categories: { Args: never; Returns: number }
      refresh_offer_types: { Args: never; Returns: number }
      update_own_profile: {
